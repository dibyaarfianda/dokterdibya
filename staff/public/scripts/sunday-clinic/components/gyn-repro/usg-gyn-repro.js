...
export default {
        ...
        return `
            <div class="card">
                <div class="card-header bg-success text-white">
                    <h5 class="mb-0">
                        <i class="fas fa-ultrasound"></i> Pemeriksaan Ultrasound (USG Reproduksi)
                    </h5>
                </div>
                <div class="card-body">
    ...
    async save(state) {
        try {
            ...
            console.log('[USG Gyn Repro] Saving data:', formData);

            return { success: true, data: formData };
        } catch (error) {
            console.error('[USG Gyn Repro] Save failed:', error);
