(function () {
    ...
    function ensureDocboardModalFrameLoaded(iframe) {
        ...
        var embedVersion = window.__assetVersion || window.STAFF_CACHE_VERSION || 'v348';
    ...
    var WIDGETS = {
        'shortcut-menu': {
            ...
            defaultConfig: {
                pinned: ['nav-dashboard', 'nav-kantor-saya', 'nav-klinik-private', 'nav-kelola-pasien', 'nav-tanya-dokter']
            },
