async function bootstrapStaffShell() {
    ...
    installLazyFeatureShim('showTemplateResepPage', 'templateResep', 'template-resep');
    ...
    [
        ...
        'openBulkPatientDeleteModal',
        'togglePatientBulkSelection',
        'toggleAllManagePatientsForBulkDelete',
        'syncWebPatients'
