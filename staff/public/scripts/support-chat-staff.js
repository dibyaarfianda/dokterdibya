...
(function () {
    ...
    function injectStyles() {
        ...
        style.textContent = [
            ...
            '#content-support-chat #sc-staff-panel{flex:1;display:flex;flex-direction:column;overflow:hidden;}',
            '#content-support-chat .sc-staff-panel-header{padding:12px 16px;border-bottom:1px solid #dee2e6;background:#f8f9fa;display:flex;justify-content:space-between;align-items:center;flex-shrink:0;}',
            ...
            '#content-support-chat .sc-staff-input-area{padding:12px;border-top:1px solid #dee2e6;display:flex;gap:8px;align-items:flex-end;flex-shrink:0;}',
            '#content-support-chat .sc-staff-input{flex:1;border:1px solid #dee2e6;border-radius:8px;padding:8px 12px;font-size:13px;resize:none;outline:none;font-family:inherit;}',
