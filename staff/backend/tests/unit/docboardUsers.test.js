...
describe('DocBoard staff directory', () => {
  ...
  test('bumps the service worker and manifest cache version', () => {
    ...
    expect(serviceWorker).toContain("docboard-pwa-20260718-2");
    expect(index).toContain('docboard-20260718-2');
    expect(main).toContain("DOCBOARD_PWA_VERSION = '20260718-2'");
    ...
    expect(staffHtml).toContain("window.STAFF_CACHE_VERSION = 'v298';");
    expect(staffServiceWorker).toContain("STAFF_PWA_VERSION = 'v298'");
  });
});
