...
router.get('/prescription-templates', verifyToken, async (req, res, next) => {
    try {
        const [rows] = await db.query(
...
router.post('/prescription-templates', verifyToken, async (req, res, next) => {
...
router.put('/prescription-templates/:id', verifyToken, async (req, res, next) => {
...
router.delete('/prescription-templates/:id', verifyToken, async (req, res, next) => {
    const templateId = Number(req.params.id);
